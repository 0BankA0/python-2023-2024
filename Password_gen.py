...
checkbox = tk.CTkCheckBox(tab_1, text="Caps",width= 900)
checkbox.pack(pady = 20, )

checkbox = tk.CTkCheckBox(tab_1, text="Symbol",width= 900)
checkbox.pack(pady = 20, )

checkbox = tk.CTkCheckBox(tab_1, text="Numbers",width= 900)
checkbox.pack(pady = 20, )

#lable = tk.CTkLabel(master=frame, text='login', text_font=('Arial', 20))
#lable.pack(pady=20, padx= 30)
