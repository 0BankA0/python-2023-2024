...
class Remontdarbnica():
    ...
    def __init__(self,klienta_vards,klienta_uzvards, telefona_numurs, remontdarbu_cena, telefona_modelis, Telefonam_peiskirtais_numurs, remontdarbu_sākuma_datum, remontdarbu_beigu_datums):
        ...
        self.remontdarbu_sākuma_datum = remontdarbu_sākuma_datum
